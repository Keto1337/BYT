...
public class AccountTest {
	...
	// testing addTimedPayment(), removeTimedPayment() and timedPaymentExists() methods from class Account
	@Test
	public void testAddRemoveTimedPayment() {
		testAccount.addTimedPayment("1", Integer.valueOf(12), Integer.valueOf(1), new Money(10000, SEK), SweBank, "Alice");
	...
	public void testTimedPayment() throws AccountDoesNotExistException {
		testAccount.addTimedPayment("1", Integer.valueOf(1), Integer.valueOf(0), new Money(1000000, SEK), SweBank, "Alice");
		assertTrue(testAccount.timedPaymentExists("1"));
